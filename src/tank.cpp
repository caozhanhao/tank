      ...
      else
      {
        switch (ch)
        {
          ...
          case 72:
            if (in_linux_like)
            {
              czh::logger::info("Ignored key 72");
              break;
            }
            game.tank_react(0, NormalTankEvent::UP);
            break;
          ...
          case 80:
            if (in_linux_like)
            {
              czh::logger::info("Ignored key 80");
              break;
            }
            game.tank_react(0, NormalTankEvent::DOWN);
            break;
          ...
          case 75:
            if (in_linux_like)
            {
              czh::logger::info("Ignored key 75");
              break;
            }
            game.tank_react(0, NormalTankEvent::LEFT);
            break;
          ...
          case 77:
            if (in_linux_like)
            {
              czh::logger::info("Ignored key 77");
              break;
            }
            game.tank_react(0, NormalTankEvent::RIGHT);
            break;
          case 'B':
            if (!in_linux_like)
            {
              czh::logger::info("Ignored key 76");
              break;
            }
            game.tank_react(0, NormalTankEvent::DOWN);
            break;
          ...
          case 13://Enter
            if (in_linux_like)
            {
              czh::logger::info("Ignored key 13");
              break;
            }
          ...
          case 10:
            if (!in_linux_like)
            {
              czh::logger::info("Ignored key 10");
              break;
            }
            game.react(Event::START);
            break;
          ...
          case '/':
            ...
            break;
          default:
            czh::logger::info("Ignored key ", static_cast<int>(ch), ".");
            break;
        }
      }
    }
